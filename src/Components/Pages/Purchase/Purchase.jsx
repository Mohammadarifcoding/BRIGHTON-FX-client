...
const Purchase = () => {
    ...
    const [purchaseData,setPurchaseeData] = useState(JSON.parse(localStorage.getItem('purchase')))
    ...
    <Container>
      <div className="lg:mt-20 mt-10 pb-40">
        ...
        <div className=" lg:mt-32 mt-14">
           <div className="">
                <h2 className="text-[#4A53A4]  font-medium sm:text-2xl text-2xl  ">Order Summary </h2>
                <div className="flex items-center  flex-col  mt-10 gap-10">

            

                <div className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-2  bg-gray-200 items-center w-full justify-between gap-6 p-3">
           ...
           <div className="">
                ...
                <div className="flex items-center  flex-col md:flex-row mt-10 gap-10">
                      ...
                      <div className=" md:w-1/2 w-full">
                         ...
                         <input type="text" className=" mt-2 w-full border-gray-500 border px-2 py-2 rounded-lg outline-gray-500" />
                      </div>
                      <div className=" md:w-1/2 w-full">
                         ...
                         {
                            currency.map(item => <option value={item.value}>{item.label}</option>)
                         }
                        </select>
                      </div>
                      <div className=" md:w-1/2 w-full">
                     ...
                     <div className=" lg:mt-8 flex lg:justify-center justify-end">
                        <button className="flex bg-[#93C94E] px-5 py-3 hover:bg-[#678c36] hover:text-white gap-2">Add <span> + </span></button>
                     </div>
                </div>
           </div>
        </div>
