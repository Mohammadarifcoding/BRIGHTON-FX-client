...
const CurrencyChart = ({ currency }) => {
    ...
    return (
        <Container>
            <div className="my-32">
                <h2 className="text-[#1E4A9A] lg:text-6xl sm:text-2xl text-xl  font-semibold lg:text-start text-center">Find your Currency</h2>
                ...
                <div className="flex justify-center mt-5">
                    {fullData.length > 20 && (
                        <button
                            ...
                            className="bg-[#93C94E] hover:bg-[#6c923a] hover:text-white  text-xl px-3 py-2 rounded-lg flex max-w-[160px] items-center gap-2"
                        >
